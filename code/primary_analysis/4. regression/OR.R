...
run_logistic_fast <- function(var) {
  formula <- as.formula(paste("has_disease_Coronary_Artery_Disease_INTERMEDIATE ~", var, "+ age + Sex + PC1 + PC2 + PC3 + PC4"))  # include other covariates
