...
cohort_p_sum <- read.csv("/home/unix/sliang/sliang/age/cohort_p_sum.csv", na.strings = c("", " "))
cohort_p <- read_csv("/home/unix/sliang/sliang/age/cohort_p_sex_specific.csv")
...
write.csv(table1_notpickedup, file = "Table1_notpickedup_sa1.csv")
...
write.csv(table1_pickedup, file = "Table1_pickedup_sa1.csv")
...
write.csv(pval_continuous, file = "pval_continuous_sa1.csv", row.names = FALSE)
...
write.csv(pval_categorical, file = "pval_categorical_sa1.csv")
